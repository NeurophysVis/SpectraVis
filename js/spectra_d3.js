SPECTRA = (function() {
  ...
  var freqSliceHeight =  180 - margin.top - margin.bottom;

  var svgFreqSlice = d3.select('#freqSlice')
        .append('svg')
  ...
  function display(isError, spect1, spect2, visInfo, edgeInfo) {
    ...
    var timeScale, timeScaleLinear, freqScale, powerScale, tAx, fAx,
        ...
        edgeStatLineFun, freqSlicePowerScale, freqSliceNetworkStatScale, spect1Line,
    ...
    function drawFreqSlice() {
      ...
      spect1Line = svgFreqSlice.selectAll('path.spect1').data([spect1.data[curTimeInd]]);
      spect1Line.enter()
        .append('path')
           .attr('class', 'spect1')
           .attr('stroke', 'green')
      ...
      spect1Line
        .transition()
          ...
          .ease('linear')
        .attr('d', powerLineFun);
      spect2Line = svgFreqSlice.selectAll('path.spect2').data([spect2.data[curTimeInd]]);
      spect2Line.enter()
        .append('path')
          .attr('class', 'spect2')
          .attr('stroke', 'green')
      ...
      spect2Line
        .transition()
          ...
          .ease('linear')
        .attr('d', powerLineFun);
      edgeStatLine = svgFreqSlice.selectAll('path.edgeStat').data([edgeStat.data[curTimeInd]]);
      edgeStatLine.enter()
        .append('path')
          .attr('class', 'edgeStat')
          .attr('stroke', 'blue')
      ...
      timeTitle = svgFreqSlice.selectAll('text.title').data([tAx[curTimeInd]]);
      timeTitle.enter()
        .append('text')
          .attr('text-anchor', 'middle')
          .attr('class', 'title')
